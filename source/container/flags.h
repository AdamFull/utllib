...
template <typename BitType>
constexpr bool operator<(BitType bit, utl::container::flags<BitType> const& flags) noexcept
{
...
// bitwise operators
template <typename BitType>
constexpr utl::container::flags<BitType> operator&(BitType bit, utl::container::flags<BitType> const& flags) noexcept
{
    return flags.operator&(bit);
}
...
using FlagsName = utl::container::flags<EnumType>; \
