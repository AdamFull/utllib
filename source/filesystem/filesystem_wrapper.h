...
namespace utl
{
	namespace filesystem
	{
		...
		public:
			...
			virtual bool fread(const std::string& path, std::vector<u8>& data) = 0;
			virtual bool fwrite(const std::string& path, const std::vector<u8>& data) = 0;
		...
		public:
			...
			bool fread(const std::string& path, std::vector<u8>& data) override;
			bool fwrite(const std::string& path, const std::vector<u8>& data) override;
